...
export default function BlogPage() {
  ...
  return (
    <div className="page-mobile-first min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div className="rounded-lg bg-gray-50 border border-gray-200 p-6">
          ...
          <p className="mt-1 text-sm text-gray-600">Send us your tips and event hacks at support@weenyou.com.</p>
        </div>
      </section>
    </div>
  );
