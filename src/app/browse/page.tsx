...
function LoadingFallback() {
  return (
    <div className="page-mobile-first min-h-screen bg-gradient-to-b from-yellow-50 via-white to-gray-50 font-sans relative overflow-x-hidden flex items-center justify-center w-full min-w-0">
