...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f5f2]">
      ...
      <section className="relative w-full h-[480px] flex flex-col justify-center items-center text-center overflow-hidden rounded-b-3xl shadow-lg mb-10">
        {/* Background Image */}
        <Image
          src="/bg.png"
          alt="Browse Venues"
        ...
        <div className="relative z-20 w-full flex flex-col items-center justify-center h-full px-4">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-4 animate-fade-in">
            Find Your Perfect Venue.<br />For Every Celebration.
          </h1>
          ...
          {/* Search Form */}
          <form onSubmit={handleSearch} className="backdrop-blur-md bg-white/80 border border-gray-200 shadow-xl rounded-2xl p-4 flex flex-col sm:flex-row gap-4 sm:gap-3 items-center w-full max-w-6xl mx-auto mt-6 animate-fade-in delay-200">
                <div className="relative w-full">
                  <input
                    ref={cityInputRef}
                    type="text"
                    className="group pl-10 pr-12 py-2 rounded-lg border border-gray-300 focus:ring-1 focus:ring-blue-400 focus:border-blue-400 min-w-[180px] md:min-w-[220px] w-full"
                    value={city}
            ...
            <div className="relative w-full md:w-auto">
              ...
              <div className="flex gap-2 items-center">
                <input
                  type="date"
                  className="group pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:ring-1 focus:ring-blue-400 focus:border-blue-400 min-w-[120px] w-auto"
                  value={startDate}
                ...
                <input
                  type="date"
                  className="group pl-3 pr-4 py-2 rounded-lg border border-gray-300 focus:ring-1 focus:ring-blue-400 focus:border-blue-400 min-w-[120px] w-auto"
                  value={endDate}
            ...
            <div className="relative w-full md:w-auto">
              ...
              <select
                className="group pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:ring-1 focus:ring-blue-400 focus:border-blue-400 min-w-[180px] md:min-w-[220px] w-auto"
                value={capacity}
            ...
            <button
              type="submit"
              className="flex items-center justify-center gap-2 bg-[#22313f] text-white px-8 min-h-[44px] min-w-[44px] rounded font-semibold text-base md:text-lg shadow-lg hover:bg-[#1a2433] transition transform hover:scale-105 focus:scale-105 duration-150"
              aria-label="Search venues"
            >
              <MagnifyingGlassIcon className="w-5 h-5 transition-transform duration-150 group-hover:scale-110" aria-hidden="true" />
              <span>Explore</span>
            </button>
          </form>
        </div>
      ...
      {/* Event Categories */}
      <section className="bg-gray-50 py-8 flex justify-center gap-8 flex-wrap shadow-sm overflow-x-auto border-b border-gray-200">
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="7" /><path d="M8 21h8M12 17v4" /></svg></span>
          <span className="font-medium">Weddings</span>
        </div>
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M4 21v-2a4 4 0 014-4h8a4 4 0 014 4v2" /><circle cx="12" cy="7" r="4" /></svg></span>
          <span className="font-medium">Birthdays</span>
        </div>
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="13" rx="2" /><path d="M16 3v4M8 3v4" /></svg></span>
          <span className="font-medium">Corporate</span>
        </div>
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 4v8l6 3" /></svg></span>
          <span className="font-medium">Cultural</span>
        </div>
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2C7.03 2 2.73 6.11 2.07 11h19.86C21.27 6.11 16.97 2 12 2zm0 20c4.97 0 9.27-4.11 9.93-9H2.07c.66 4.89 4.96 9 9.93 9z" /></svg></span>
          <span className="font-medium">Religious</span>
        </div>
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2" /><path d="M4 9h16M9 4v16" /></svg></span>
          <span className="font-medium">Exhibitions</span>
        </div>
        <div className="flex flex-col items-center min-w-[100px] mx-2">
          <span className="bg-[#e7dac7] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><path d="M16 8a4 4 0 01-8 0" /></svg></span>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {loadingHalls ? (
              ...
              <div key={hall._id || i} className="bg-[#f6f5f2] rounded-xl shadow-lg p-4 flex flex-col transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
                <Image
                ...
                />
                <div className="font-semibold text-lg mb-1">{hall.name}</div>
                <div className="text-gray-500 text-sm mb-1 line-clamp-2">{hall.description}</div>
                <div className="flex items-center text-gray-600 text-xs mb-1 gap-2">
                  <span className="flex items-center gap-1">
                    <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                    {hall.location?.city}, {hall.location?.state}
                  </span>
                  <span className="flex items-center gap-1">
                    <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>
                    {hall.capacity || 'N/A'} guests
                  </span>
                </div>
                <div className="flex items-center text-xs text-gray-600 mb-1 gap-2">
                  <span className="flex items-center gap-1">
                    <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.967a1 1 0 00.95.69h4.178c.969 0 1.371 1.24.588 1.81l-3.385 2.46a1 1 0 00-.364 1.118l1.287 3.966c.3.922-.755 1.688-1.54 1.118l-3.385-2.46a1 1 0 00-1.175 0l-3.385 2.46c-.784.57-1.838-.196-1.54-1.118l1.287-3.966a1 1 0 00-.364-1.118l-3.385-2.46c-.783-.57-.38-1.81.588-1.81h4.178a1 1 0 00.95-.69l1.286-3.967z" /></svg>
                ...
                <div className="flex flex-wrap gap-1 text-xs text-gray-500 mb-2">
                  {Array.isArray(hall.amenities) && hall.amenities.slice(0, 3).map((amenity, idx) => (
                    <span key={idx} className="bg-gray-200 rounded px-2 py-0.5">{amenity}</span>
                  ))}
                  {Array.isArray(hall.amenities) && hall.amenities.length > 3 && (
                    <span className="bg-gray-200 rounded px-2 py-0.5">+{hall.amenities.length - 3} more</span>
                  )}
                </div>
                <div className="text-gray-800 font-medium mb-2">₹{hall.price ? hall.price.toLocaleString() : 'N/A'}{hall.priceType === 'per plate' ? ' per plate' : ''}</div>
                <a
                  href={`/halls/${hall._id}`}
                  className="mt-auto border border-primary-600 text-primary-600 bg-transparent hover:bg-primary-50 font-semibold py-2 px-4 rounded transition text-center block"
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              <span className="bg-[#f3e6d2] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><path d="M8 12h8M12 8v8" /></svg></span>
              <div className="font-semibold mb-1">Search & Discover</div>
              <div className="text-gray-600 text-sm">Search verified venues across india.</div>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="bg-[#f3e6d2] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 8v4l3 3" /><circle cx="12" cy="12" r="10" /></svg></span>
              <div className="font-semibold mb-1">Request & Confirm</div>
              <div className="text-gray-600 text-sm">Request booking & confirm instantly</div>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="bg-[#f3e6d2] rounded-full p-4 mb-2"><svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 6L9 17l-5-5" /></svg></span>
              <div className="font-semibold mb-1">Celebrate & Enjoy</div>
              <div className="text-gray-600 text-sm">Host your event with peace of mind</div>
            </div>
          </div>
        </div>
      </section>
