        ...
        <div className="max-w-[420px] w-full">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="mt-3 text-gray-500 text-center">
              Sign in with your administrative credentials to manage WeEnYou.
            </p>
          </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden bg-gray-900">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-20 text-white">
          <div className="max-w-md">
            <h2 className="text-5xl font-extrabold mb-6 leading-tight text-[#C89B3C]">
              Administrative Interface
            </h2>
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Highly secured management portal for WeEnYou platform operations and user oversight.
            </p>
          </div>
        </div>
      </div>
