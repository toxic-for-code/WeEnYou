      ...
      <div className="min-h-screen flex items-center justify-center bg-[#fafafa] px-6">
        <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-xl p-10 text-center animate-fade-in border border-gray-100">
          ...
          <p className="text-gray-500 mb-8">
            Logged in as <span className="text-[#C89B3C] font-semibold">{session.user.name || session.user.email}</span>
          </p>
          <Link 
            href="/"
        ...
        <div className="max-w-[420px] w-full">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="mt-3 text-gray-500 text-center">
              Enter your details to access your WeEnYou account.
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link href="#" className="text-xs font-bold text-[#C89B3C] hover:underline">
                    Forgot Password?
                  </Link>
                </div>
                <div className="relative group">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-[52px] flex items-center justify-center bg-gray-900 text-white rounded-2xl font-bold text-lg hover:bg-black transition-all hover:scale-[1.01] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-xl shadow-black/10"
            >
              {loading ? (
            ...
            <p className="text-center text-gray-500 text-sm">
              ...
              <Link href="/auth/signup" className="font-bold text-[#C89B3C] hover:underline">
                Create Account
              </Link>
            </p>
          </form>
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-20 text-white">
          <div className="max-w-md">
            <h2 className="text-5xl font-extrabold mb-6 leading-tight">
              Host Memorable Events with Ease
            </h2>
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Explore verified venues across India and make your celebrations truly special.
            </p>
            <div className="flex gap-4">
              ...
              <p className="text-gray-300 text-sm py-2">
                Joined by <span className="text-white font-bold">10,000+</span> event organizers
              </p>
            </div>
          </div>
        </div>
